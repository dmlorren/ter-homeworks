...
variable "vm_web_platform" {
  type        = string
  default     = "standard-v1"
  description = "Platform standard for vm"
}
...
variable "metadata" {
  ...
  default = {
    ...
    ssh-keys = "ubuntu:ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIKTwkYsVoXBBrWz0W6n30wOlcIjaAd8y0OOuAkUBFNn7 dmlorren@ubunty2004"
  }
}
...
variable "vm_web_preemptible" {
  type        = bool
  default     = true
  description = "Preemptible for web vm"
}
...
variable "vm_storage_name" {
  type        = string
  default     = "storage"
  description = "name storage for vm"
}
